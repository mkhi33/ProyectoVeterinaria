...
public class GuiMascotas extends JInternalFrame {
    ...
    private void diseñoPanelIzquierdo(){
        ...
        leftPanel.add(txtIdPropietario);
        leftPanel.add(txtFechaNacimiento);
        leftPanel.add(txtNombreMascota);

                
        // Labels para el formulario
        leftPanel.add(lblIdPropietario); 
        leftPanel.add(lblFechaNacimiento); 
        leftPanel.add(lblNombreMascota); 
        ...
        txtIdPropietario.setBounds(70,100, 220, 30);
        txtFechaNacimiento.setBounds(70,180,220,30);
        txtNombreMascota.setBounds(70,260,220,30);
        ...
        lblIdPropietario.setBounds(60, 60, 140, 30);
        lblFechaNacimiento.setBounds(60, 150, 190, 30);
        lblNombreMascota.setBounds(60,230,190,30);
       

        lblIdPropietario.setBackground(new java.awt.Color(255, 255, 255));
        lblIdPropietario.setFont(new java.awt.Font("Cantarell Extra Bold", 0, 18)); // NOI18N
        lblIdPropietario.setForeground(new java.awt.Color(0, 204, 204));
        ...
        lblNombreMascota.setBackground(new java.awt.Color(255, 255, 255));
        lblNombreMascota.setFont(new java.awt.Font("Cantarell Extra Bold", 0, 18)); // NOI18N
        lblNombreMascota.setForeground(new java.awt.Color(0, 204, 204));
