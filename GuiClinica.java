...
public class GuiClinica extends JInternalFrame {
    ...
    private JLabel lblTransparente;
    ...
    private JLabel lblTelefonoClinica;
    private JLabel lblDireccionClinica;
    private JLabel lblCorreoElectronico;
    private JLabel lblTxtClinica;
    private JLabel lblTxtClinica1;
    private JLabel lblTxtId;
    private JPanel leftPanel;
    private JPanel rightPanel;
    private JTable tbl;
    private JTextField txtBuscar;
    private JTextField txtCorreoClinica;
    private JTextField txtDireccionClinica;
    ...
    private void inicializarComponentes(){
        ...
        lblTxtId = new JLabel();
        lblClinica = new JLabel();
        txtNombreClinica = new JTextField(10);
        lblTxtClinica1 = new JLabel();
        txtTelefonoClinica = new JTextField(10);
        txtDireccionClinica = new JTextField(10);
        lblTelefonoClinica = new JLabel();
        lblTxtClinica = new JLabel();
        txtCorreoClinica = new JTextField(10);
        jLabel2 = new JLabel();
        lblDireccionClinica = new JLabel();
        jLabel1 = new JLabel();
    ...
    private void diseñoPanelDerecho(){
        ...
        rightPanel.add(lblTransparente);
        ...
        lblTransparente.setBounds(40, 30, 100, 190);
    ...
    private void diseñoPanelIzquierdo(){
        ...
        leftPanel.add(lblID);
        leftPanel.add(txtId);
        leftPanel.add(lblTxtId);
        leftPanel.add(txtNombreClinica);
        leftPanel.add(lblTxtClinica1);
        leftPanel.add(txtTelefonoClinica);
        leftPanel.add(txtDireccionClinica);
        leftPanel.add(txtDireccionClinica);
        leftPanel.add(lblTelefonoClinica);
        leftPanel.add(lblTxtClinica);
        leftPanel.add(txtCorreoClinica);
        leftPanel.add(jLabel2);
        leftPanel.add(lblDireccionClinica);
        leftPanel.add(jLabel1);
        leftPanel.add(lblCorreoElectronico);
        ...
        txtNombreClinica.setBounds(70,100, 220, 30);
        txtDireccionClinica.setBounds(70,180,220,30);
        txtCorreoClinica.setBounds(70,260,220,30);
        txtTelefonoClinica.setBounds(70,350,220,30);
        txtId.setBounds(320,20,30,15);


        // Labels y personalización
        lblID.setBounds(280, 10, 20, 30);
        lblClinica.setBounds(60, 60, 140, 30);
        lblDireccionClinica.setBounds(60, 150, 190, 30);
        lblCorreoElectronico.setBounds(60,230,190,30);
        lblTelefonoClinica.setBounds(60, 310, 190, 30);




        lblClinica.setBackground(new java.awt.Color(255, 255, 255));
        lblClinica.setFont(new java.awt.Font("Cantarell Extra Bold", 0, 18)); // NOI18N
        lblClinica.setForeground(new java.awt.Color(0, 204, 204));
        lblClinica.setText("Nombre Clinica");

        lblDireccionClinica.setBackground(new java.awt.Color(255, 255, 255));
        lblDireccionClinica.setFont(new java.awt.Font("Cantarell Extra Bold", 0, 18)); // NOI18N
        lblDireccionClinica.setForeground(new java.awt.Color(0, 204, 204));
        lblDireccionClinica.setText("Dirección Clinica");

        lblCorreoElectronico.setBackground(new java.awt.Color(255, 255, 255));
        lblCorreoElectronico.setFont(new java.awt.Font("Cantarell Extra Bold", 0, 18)); // NOI18N
        lblCorreoElectronico.setForeground(new java.awt.Color(0, 204, 204));
        lblCorreoElectronico.setText("Correo Electronico");

        lblTelefonoClinica.setBackground(new java.awt.Color(255, 255, 255));
        lblTelefonoClinica.setFont(new java.awt.Font("Cantarell Extra Bold", 0, 18)); // NOI18N
        lblTelefonoClinica.setForeground(new java.awt.Color(0, 204, 204));
        lblTelefonoClinica.setText("Telefono");
