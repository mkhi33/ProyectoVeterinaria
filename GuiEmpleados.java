...
public class GuiEmpleados extends JInternalFrame {
    ...
    private JTextField txtFechaInicioLaborar;
    ...
    private JLabel lblFechaInicioLaborar;
    ...
    private void inicializarComponentes(){
        ...
        txtFechaInicioLaborar = new JTextField();
        ...
        lblFechaInicioLaborar = new JLabel();
    ...
    private void diseñoPanelIzquierdo(){
        ...
        leftPanel.add(txtFechaInicioLaborar);
        leftPanel.add(txtSueldo);
        
        leftPanel.add(lblNombre);
        leftPanel.add(lblApellido);
        leftPanel.add(lblDni);
        leftPanel.add(lblFechaNacimiento);
        leftPanel.add(lblFechaInicioLaborar);
        leftPanel.add(lblSueldo);
        ...
        txtFechaInicioLaborar.setBounds(70,300,220,30);
        txtSueldo.setBounds(70,360,220,30);
        ...
        lblFechaInicioLaborar.setBounds(60, 270, 190, 30);
        lblSueldo.setBounds(60, 330, 190, 30);
        ...
        lblFechaInicioLaborar.setBackground(new java.awt.Color(255, 255, 255));
        lblFechaInicioLaborar.setFont(new java.awt.Font("Cantarell Extra Bold", 0, 18)); // NOI18N
        lblFechaInicioLaborar.setForeground(new java.awt.Color(0, 204, 204));
        lblFechaInicioLaborar.setText("Fecha Inicio Laborar");

        lblSueldo.setBackground(new java.awt.Color(255, 255, 255));
        lblSueldo.setFont(new java.awt.Font("Cantarell Extra Bold", 0, 18)); // NOI18N
        lblSueldo.setForeground(new java.awt.Color(0, 204, 204));
